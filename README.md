...
- [Try it out locally](#sandbox) without any hardware!
- [Deploy on real hardware](#prerequisites) for production

## Roadmap

See [roadmap](#roadmap) and [open issues](#issues) for a list of proposed features and known issues.
...
Copyright &copy; 2020 - 2022 Foo Bar

Distributed under the GPLv3 License.
See [license page](#license) or `LICENSE.md` file for more information.
